...
public class FirstStepView extends View {
    ...
    private void init(Context context) {
        // 这个就是那个椭圆形图片
        initialBitmap = Bitmap.createBitmap(BitmapFactory.decodeResource(getResources(),
                R.mipmap.loading_1));
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        scaledBitmap = Bitmap.createScaledBitmap(initialBitmap, measuredWidth, measuredWidth
                * initialBitmap.getHeight() / initialBitmap.getWidth(), true);
    }
