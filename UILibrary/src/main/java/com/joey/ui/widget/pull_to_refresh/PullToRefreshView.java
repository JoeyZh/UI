...
public class PullToRefreshView extends LinearLayout {
     ...
     * header view image
     */
    private FirstStepView mHeaderImageView;
    /**
     * footer view image
     */
    ...
    /**
     * status refresh listener
     */
    private OnHeaderRefreshStateChangeListener mHeaderRefreshStateChangeListener;
    ...
    private void addHeaderView() {
        ...
        mHeaderImageView = (FirstStepView) mHeaderView.findViewById(R.id.pull_to_refresh_image);
        ...
        drawable = (AnimationDrawable) mHeaderProgressBar.getBackground();
    ...
    private void addFooterView() {
        ...
        drawable_foot = (AnimationDrawable) mFooterProgressBar.getBackground();
        // footer business_main
    ...
    private void initContentAdapterView() {
        ...
        if (count < 3) {
            throw new IllegalArgumentException("this business_main must contain 3 child views,and AdapterView or ScrollView must in the second position!");
        }
        View view = null;
        ...
        if (mAdapterView == null && mScrollView == null) {
            throw new IllegalArgumentException("must contain a AdapterView or ScrollView in this business_main!");
        }
    }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mPullState == PULL_DOWN_STATE) {
                    ...
                    offsetY = (tempY - startY) / 5;
                    //	startY = tempY;
                    //	float currentHeight = (-mHeaderViewHeight+offsetY/3);
                    currentProgress = offsetY / mHeaderViewHeight;
                    if (currentProgress >= 1) {
                        currentProgress = 1;
                    }
                    Log.d(TAG,
                            "currentProgress==========" + currentProgress);
                    mHeaderImageView.setCurrentProgress(currentProgress);
                    mHeaderImageView.postInvalidate();
                    ...
                    //	startY = tempY;
                    //	float currentHeight = (-mHeaderViewHeight+offsetY/3);
                    currentProgress = offsetY / mFooterViewHeight;
                    if (currentProgress <= 0) {
                        currentProgress = 0;
                    }
                    currentProgress = 1 - currentProgress;
                    Log.d(TAG, "currentProgress==========" + currentProgress);
                    mFooterImageView.setCurrentProgress(currentProgress);
                    mFooterImageView.postInvalidate();
...
//			mHeaderImageView.startAnimation(mFlipAnimation);
            LogUtils.a("release_to_refresh");
            if (mHeaderRefreshStateChangeListener != null)
                mHeaderRefreshStateChangeListener.onRefreshStart(mHeaderState);
...
//		mFooterImageView.setImageDrawable(null);
    ...
    public void onHeaderRefreshComplete() {
        ...
        //	mHeaderImageView.setImageResource(R.mipmap.xiala);
        mHeaderTextView.setText(R.string.pull_to_refresh);
        mHeaderProgressBar.setVisibility(View.GONE);
        drawable.stop();
        mHeaderState = PULL_TO_REFRESH;
        if (mHeaderRefreshStateChangeListener != null)
            mHeaderRefreshStateChangeListener.onRefreshComplete(PULL_UP_STATE);
...
//		mFooterImageView.setImageResource(R.mipmap.shangla_);
        mFooterTextView.setText(R.string.push_to_load);
    ...
    public void setHeaderRefreshStateChangeListener(OnHeaderRefreshStateChangeListener mHeaderRefreshStateChangeListener) {
        this.mHeaderRefreshStateChangeListener = mHeaderRefreshStateChangeListener;
    }
    ...
    public interface OnHeaderRefreshStateChangeListener {
        void onRefreshStart(int status);
